...
INSERT INTO "new_IssuePDF" ("blob", "contentType", "createdAt", "fileName", "id", "issueId", "updatedAt") SELECT "blob", "contentType", "createdAt", "fileName", "id", "issueId", "updatedAt" FROM "IssuePDF";
DROP TABLE "IssuePDF";
