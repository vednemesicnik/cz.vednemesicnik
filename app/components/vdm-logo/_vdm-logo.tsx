...
export const VdmLogo = ({ className, variant = "default" }: Props) => {
  ...
  const gradientColor = {
    default: ["#0068b8", "#43d6a9", "#5cffa3"],
    editMode: ["#9e00b8", "#d6435d", "#ff5c5c"],
  }
  ...
  return (
    ...
    >
      ...
      <g clipPath={"url(#_clip1)"}>
        ...
        <path d={"M200,152L392,152L776,800L776,848L608,848L200,152Z"} style={{ fill: mainColor[variant] }} />
        <path
          d={
      ...
      <defs>
        ...
        >
          <stop offset={"0"} style={{ stopColor: gradientColor[variant][0], stopOpacity: 1 }} />
          <stop offset={"0.52"} style={{ stopColor: gradientColor[variant][1], stopOpacity: 1 }} />
          <stop offset={"1"} style={{ stopColor: gradientColor[variant][2], stopOpacity: 1 }} />
        </linearGradient>
      </defs>
    </svg>
  )
