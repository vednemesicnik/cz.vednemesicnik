...
import { type action as generateRegistrationOptionsAction } from "~/routes/administration.authentication.generate-registration-options.$username/_action"
...
export const BiometricModal = ({ isOpen, onClose }: Props) => {
  ...
  }, [options, onClose, verifyRegistrationResponse])
